...
class PostCodeP001(DataSourceConfig):
    """
    Configuration class for Postcode P001 data source.
    ...
    def __init__(
        ...
        """
        Initialise Postcode P001 configuration.
    ...
    def download_links(self) -> list[str]:
        """
        Get the download links for Postcode P001 data.
    ...
    @classmethod
    def create_default(cls) -> "PostCodeP001":
        """Create a default Postcode P001 configuration."""
        return cls(
